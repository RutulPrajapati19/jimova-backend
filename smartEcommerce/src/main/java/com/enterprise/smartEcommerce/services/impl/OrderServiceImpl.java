...
public class OrderServiceImpl implements OrderService {
    ...
    private OrderResponse mapToResponse(Order order, String message) {
        List<com.enterprise.smartEcommerce.dtos.OrderItemResponse> itemResponses = order.getItems() != null ?
                order.getItems().stream().map(item -> com.enterprise.smartEcommerce.dtos.OrderItemResponse.builder()
